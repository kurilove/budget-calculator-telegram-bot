...
async def expenses_handler(message: types.Message):
    ...
    await bot.send_photo(message.chat.id,
                         photo="https://s0.rbk.ru/v6_top_pics/resized/590xH/media/img/4/79/756014514886794.jpg",
...
async def income_handler(message: types.Message):
    ...
    income_open = True
    await bot.send_photo(message.chat.id,
                         photo="https://promdevelop.com/wp-content/uploads/Jerene-Mar-2016-pay-shutterstock-700x420.jpg",
...
async def report(message: types.Message):
    ...
    await bot.send_photo(message.chat.id,
                         photo="https://euromed-economists.org/wp-content/uploads/2018/01/moneyfinance-1.jpg",
                         caption=f"""
<em>Ваши расходы </em>                            
